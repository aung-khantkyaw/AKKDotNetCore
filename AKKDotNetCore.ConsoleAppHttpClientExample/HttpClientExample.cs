...
namespace AKKDotNetCore.ConsoleAppHttpClientExample
{
    internal class HttpClientExample
    {
        private readonly HttpClient _client = new HttpClient() { BaseAddress = new Uri("https://localhost:7126") };
        ...
        public async Task RunAsync()
        {
            ...
            //await UpdateAsync(22, "title 1", "author 2", "content 3");
