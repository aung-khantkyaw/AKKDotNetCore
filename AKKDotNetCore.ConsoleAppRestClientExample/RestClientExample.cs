...
namespace AKKDotNetCore.ConsoleAppRestClientExample
{
    internal class RestClientExample
    {
        private readonly RestClient _client = new RestClient(new Uri("https://localhost:7126"));
        ...
        public async Task RunAsync()
        {
            ...
            //await UpdateAsync(23, "title 1", "author 2", "content 3");
